    ...
    .container
      .information_lists
        .information_list.participate
          p.information_list_theme {{ $t('information.theme.whom') }}
          p.information_list_content {{ $t('information.content.whom') }}
...
@import '~/assets/scss/organisms/SecInformation.scss';
</style>
